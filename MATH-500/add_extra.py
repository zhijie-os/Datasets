...
df = pd.read_parquet('/mnt/nvme2n1/x30069129/dataset/MATH-500/test.parquet')
...
df.to_parquet('/mnt/nvme2n1/x30069129/dataset/MATH-500/test_updated.parquet', index=False)
